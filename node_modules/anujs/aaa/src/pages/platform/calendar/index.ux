<import name="anu-calendar" src="../../../components/Calendar/index.ux"></import>
<import name="anu-page-wrapper" src="../../../components/PageWrapper/index.ux"></import>
<template>
    <anu-page-wrapper>
        <div class="anu-col">
            <anu-calendar data-instance-uid="{{'i167_16_' + 0}}"></anu-calendar>
        </div>
    </anu-page-wrapper>
</template>
<script>
...
Data = React.registerPage(Data, "pages/platform/calendar/index");
export default Data;
</script>
