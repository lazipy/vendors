...
<template>
    <anu-page-wrapper>
        <div class="anu-block"><canvas class="globalAlpha" id="globalAlpha" style="{{props['style1508'] }}"></canvas></div>
    </anu-page-wrapper>
</template>
<script>
...
Data = React.registerPage(Data, "pages/apis/canvas/globalAlpha/index");
export default Data;
</script>
