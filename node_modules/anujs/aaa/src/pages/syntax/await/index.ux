...
<template>
    <anu-page-wrapper>
        <div>
            <div style="{{props['style1507'] }}"><text>async/await</text></div>
            <div><text>status:</text><text>{{state.status}}</text></div>
            <div onclick="dispatchEvent" data-click-uid="e36_24" data-beacon-uid="default"><text>试一试</text></div>
        </div>
    </anu-page-wrapper>
</template>
<script>
...
P = React.toClass(P, React.Component, {
    ...
    render: function() {
        ...
        }, "async/await"), h("div", null, "status:", this.state.status), h("div", {
            onClick: this.tapHander,
            "data-click-uid": "e36_24",
            "data-beacon-uid": "default"
        }, "试一试"));;
    },
    classUid: "c1004"
}, {});
P = React.registerPage(P, "pages/syntax/await/index");
export default P;
</script>
