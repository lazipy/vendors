...
<template>
    <anu-page-wrapper>
        <div>
            ...
            <div class="page_bd">
                <div class="navigation"><video src="{{state.src}}" controls="{{state.controls}}" danmuList="{{state.danmuList}}" loop="{{state.loop}}" enableDanmu="{{state.enableDanmu}}" danmuBtn="{{state.danmuBtn}}"></video></div>
            </div>
        </div>
    </anu-page-wrapper>
</template>
...
P = React.registerPage(P, "pages/native/video/index");
export default P;
</script>
