...
import {
    holidays
} from "../../common/utils/holidayDate.js";
    ...
    render: function() {
        ...
        return h("div", {
            ...
            return h("list-item", {
                ...
                return item.isBlank ? h("div", {
                    class: "item",
                    key: item.middleText
                }) : h("div", {
                    key: item.middleText,
                    onClick: this.dateSelected.bind(this, item),
                    class: 'anu-flex-center anu-col-flex item item-a ' + item.className,
                    "data-click-uid": 'e289_44_' + i10185 + '-' + i10576,
        ...
        }, this)), this.props.isMultiSelect && h("div", null, h("div", {
            className: "e-btn-padding"
        }), h("div", {
            className: "e-btn",
            onClick: this.multiSelectFinish.bind(this),
            "data-click-uid": "e309_44",
            "data-beacon-uid": "default"
        }, h("text", {
            className: "textColor"
        }, "确定"))));;
