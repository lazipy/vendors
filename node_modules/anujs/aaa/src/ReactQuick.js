...
function onNetworkStatusChange(callback) {
  network.subscribe({
    callback: function (_ref2) {
      ...
      callback({
        isConnected: ['wifi', '4g', '3g', '2g'].includes(networkType),
...
function more() {
  return {
    ...
    getPushProvider: getPushProvider,
    subscribe: subscribe,
