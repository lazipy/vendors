      ...
      <div className="project-token">
        ...
        <div>
          <ul className="open-api">
            <li>/prd/api/open/run_auto_test [运行自动化测试]</li>
            <li>/prd/api/open/import_data [导入数据]</li>
            <li>/prd/api/interface/add [新增接口]</li>
            <li>/prd/api/interface/save [保存接口]</li>
            <li>/prd/api/interface/up [更新接口]</li>
            <li>/prd/api/interface/get [获取接口]</li>
            <li>/prd/api/interface/list [获取接口列表]</li>
            <li>/prd/api/interface/list_menu [获取接口菜单]</li>
            <li>/prd/api/interface/add_cat [新增接口分类]</li>
            <li>/prd/api/interface/getCatMenu [获取所有分类]</li>
          </ul>
        </div>
      </div>
    );
