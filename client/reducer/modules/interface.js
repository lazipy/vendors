...
export async function deleteInterfaceData(id) {
  let result = await axios.post('/prd/api/interface/del', {id: id});
  return {
...
export async function saveImportData(data) {
  let result = await axios.post('/prd/api/interface/save', data);
  return {
...
export async function deleteInterfaceCatData(id) {
  let result = await axios.post('/prd/api/interface/del_cat', {catid: id});
  return {
...
export async function fetchInterfaceData(interfaceId) {
  let result = await axios.get('/prd/api/interface/get?id=' + interfaceId);
  return {
...
export async function fetchInterfaceListMenu(projectId) {
  let result = await axios.get('/prd/api/interface/list_menu?project_id=' + projectId);
  return {
...
export async function fetchInterfaceList(params) {
  let result = await axios.get('/prd/api/interface/list', {
    params,
...
export async function fetchInterfaceCatList(params) {
  let result = axios.get('/prd/api/interface/list_cat', {
    params,
    paramsSerializer: params => {
      return qs.stringify(params, {indices: false})
    }
