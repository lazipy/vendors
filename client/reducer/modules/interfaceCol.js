...
export function fetchInterfaceColList(projectId) {
  return {
    ...
    payload: axios.get('/prd/api/col/list?project_id=' + projectId)
  };
}
...
export function fetchCaseData(caseId) {
  return {
    ...
    payload: axios.get('/prd/api/col/case?caseid=' + caseId)
  };
}
...
export function fetchCaseList(colId) {
  return {
    ...
    payload: axios.get('/prd/api/col/case_list/?col_id=' + colId)
  };
}
...
export function fetchCaseEnvList(col_id) {
  return {
    ...
    payload: axios.get('/prd/api/col/case_env_list', {
      params: { col_id }
    })
  };
}
...
export function fetchVariableParamsList(colId) {
  return {
    ...
    payload: axios.get('/prd/api/col/case_list_by_var_params?col_id=' + colId)
  };
}
