...
export function fetchGroupMsg(id) {
  return {
    ...
    payload: axios.get('/prd/api/group/get', {
      params: { id }
    })
  };
}
...
export function addMember(param) {
  return {
    ...
    payload: axios.post('/prd/api/group/add_member', param)
  };
}
...
export function delMember(param) {
  return {
    ...
    payload: axios.post('/prd/api/group/del_member', param)
  };
}
...
export function changeMemberRole(param) {
  return {
    ...
    payload: axios.post('/prd/api/group/change_member_role', param)
  };
}
...
export function changeGroupMsg(param) {
  return {
    ...
    payload: axios.post('/prd/api/group/up', param)
  };
}
...
export function deleteGroup(param) {
  return {
    type: DEL_GROUP,
    payload: axios.post('/prd/api/group/del', param)
  };
}
...
export function fetchGroupMemberList(id) {
  return {
    ...
    payload: axios.get('/prd/api/group/get_member_list', {
      params: { id }
    })
  };
}
...
export function fetchGroupList() {
  return {
    ...
    payload: axios.get('/prd/api/group/list')
  };
}
